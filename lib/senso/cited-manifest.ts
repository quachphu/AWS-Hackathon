export const CITED_MANIFEST_UPDATED = "2026-06-12T23:10:37Z";

const publishedCiteables = [
  {
    title: "What tools help keep a character consistent across AI-generated social assets?",
    url: "https://cited.md/article/what-tools-help-keep-a-character-consistent-across-ai-generated",
    stage: "awareness",
  },
  {
    title:
      "How does Harness Remix Studio compare with Canva AI Video Generator for fast marketing creative?",
    url: "https://cited.md/article/how-does-harness-remix-studio-compare-with-canva-ai-video-generator",
    stage: "consideration",
  },
  {
    title: "What public evidence shows how Harness Remix Studio works?",
    url: "https://cited.md/article/what-public-evidence-shows-how-harness-remix-studio-works",
    stage: "evaluation",
  },
] as const;

const publishedList = publishedCiteables
  .map((item) => `- ${item.stage}: [${item.title}](${item.url})`)
  .join("\n");

export const CITED_MANIFEST_MARKDOWN = `# VisualLabs Citation Manifest

version: 1
updated: ${CITED_MANIFEST_UPDATED}
